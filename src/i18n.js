    ...
    resources: {
        ...
        translation: {
          ...
          coffee: {
            name: {
              ...
              bonbon: 'Bonbon (espresso and condensed milk)',
        ...
        translation: {
          ...
          coffee: {
            name: {
              ...
              latte: 'Латте',
              flatWhite: 'Флет-вайт',
              bonbon: 'Бонбон (эспрессо и сгущённое молоко)',
        ...
        translation: {
          ...
          coffee: {
            name: {
              ...
              latte: 'Latte',
              flatWhite: 'Flat White',
              bonbon: 'Bonbon (espresso y leche condensada)',
      ...
      uk: {
        translation: {
          ...
          tostadas: {
            name: {
              poached: 'Тостада з яйцями пашот, гуакамоле, лососем і соусом бернез',
          ...
          brunches: {
            name: {
              ...
              greek: 'Грецький бранч (омлет з помідорами, перцем, сиром Фета та оливками; на десерт пампушка з ванільним кремом та фруктами; кава, апельсиновый сік або лимонад на вибір)'
            }
          },
          naturalTea: {
            name: {
          ...
          coffee: {
            name: {
              ...
              latte: 'Лате',
              flatWhite: 'Флет-вайт',
              bonbon: 'Бонбон (еспресо та згущене молоко)',
              carajillo: 'Карахільо (еспресо та бренді)',
